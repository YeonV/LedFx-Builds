...
a = Analysis([f'{spec_root}\\ledfx\\__main__.py'],
             ...
             hiddenimports=['sacn', 'aubio', 'numpy', 'notifypy', 'math', 'voluptuous', 'numpy', 'aiohttp', 'mido','mido.frozen', 'paho', 'paho.mqtt', 'openrgb-python', 'openrgb', 'python-rtmidi','rtmidi', 'mido.backends.rtmidi', 'paho.mqtt.client','samplerate', 'samplerate._src', 'samplerate._samplerate_data', 'sounddevice',

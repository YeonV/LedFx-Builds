# simple custom blackhole driver
...
```
xcodebuild -project LedFx.xcodeproj -configuration Release PRODUCT_BUNDLE_IDENTIFIER="audio.blade.BlackHole" PRODUCT_NAME="LedFx" GCC_PREPROCESSOR_DEFINITIONS='$GCC_PREPROCESSOR_DEFINITIONS kDriver_Name=\"LedFx\" kPlugIn_BundleID=\"audio.blade.BlackHole\" kPlugIn_Icon=\"LedFx.icns\" kDevice_Name=\"LedFx\"'
```

unsigned:

```
xcodebuild -project LedFx.xcodeproj -configuration Release PRODUCT_BUNDLE_IDENTIFIER="audio.blade.BlackHole" PRODUCT_NAME="LedFx" CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED=NO GCC_PREPROCESSOR_DEFINITIONS='$GCC_PREPROCESSOR_DEFINITIONS kDriver_Name=\"LedFx\" kPlugIn_BundleID=\"audio.blade.BlackHole\" kPlugIn_Icon=\"LedFx.icns\" kDevice_Name=\"LedFx\"'
```

### Install & Load

```
sudo rm -rf /Library/Audio/Plug-Ins/HAL/LedFx.driver && sudo cp -R build/Release/LedFx.driver /Library/Audio/Plug-Ins/HAL/ && sudo killall -9 coreaudiod
````

---

Original Repo: https://github.com/ExistentialAudio/BlackHole

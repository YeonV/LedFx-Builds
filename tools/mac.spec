...
a = Analysis([f'{spec_root}/ledfx/__main__.py'],
             ...
             hiddenimports=['sacn', 'aubio', 'numpy', 'math', 'voluptuous', 'numpy', 'aiohttp', 'mido','mido.frozen', 'paho', 'paho.mqtt', 'python-rtmidi','rtmidi', 'mido.backends.rtmidi', 'paho.mqtt.client', 'samplerate', 'sounddevice',

...
a = Analysis([f'{spec_root}/ledfx/__main__.py'],
             ...
             hiddenimports=['sacn', 'aubio', 'numpy', 'notify-py', 'math', 'voluptuous', 'numpy', 'aiohttp', 'mido','mido.frozen', 'paho', 'paho.mqtt', 'python-rtmidi', 'openrgb-python', 'openrgb', 'rtmidi', 'mido.backends.rtmidi', 'paho.mqtt.client','samplerate', 'samplerate._src', 'sounddevice',
